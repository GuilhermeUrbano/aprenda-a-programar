...
let i = 0
let valorVenda = 0
let numeroDeVendas = receita.length

while (i < numeroDeVendas) {
    valorVenda = (valorVenda + receita[i].valor)
    i++
}
console.log(`O valor total de vendas sem gorgeta foi de R$ ${valorVenda}`)
...
while (i < numeroDeVendas) {
    valorGorjeta = (valorGorjeta + receita[i].gorjeta)
    i++
}
console.log(`O valor total de vendas incluindo a gorgeta foi de R$ ${valorVenda + valorGorjeta}`)
...
console.log(`${abaixo50} vendas foram abaixo de 50 reais`)
